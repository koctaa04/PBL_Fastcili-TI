                ...
                <div class="card border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-0">
                            ...
                            <div>
                                <a href="{{ asset('template_user.xlsx') }}" class="btn btn-info" download>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label bg-light text-center" for="file_user" id="file-label">
                            ...
                            <small class="text-danger" id="error-file_user"></small>
                        </div>
                    </div>
                </div>
            </div>
