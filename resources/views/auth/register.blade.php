    ...
    <div class="container-login">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-5 d-none d-md-block ml-auto">
                ...
                <div class="terms info-horizontal">
                    <p class="mt-2 description text-end text-white"><small>Terakhir diperbarui: {{ now()->format('d F Y') }}</small></p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mx-auto">
                <div class="card card-signup text-center bg-white">
                    <div class="card-header bg-white border-0 pb-0">
                        ...
                        <button class="btn btn-link d-md-none terms-toggle text-dark" type="button" data-toggle="collapse" data-target="#termsCollapse">
                    ...
                    <div class="collapse d-md-none" id="termsCollapse">
                        <div class="card-body terms-mobile bg-light m-3 rounded">
                            <button type="button" class="close text-dark" data-toggle="collapse" data-target="#termsCollapse" aria-label="Close">
                            ...
                            <div class="description">
                                ...
                                <ul class="small text-dark">
                                    <li>Sistem ini hanya dapat digunakan oleh civitas akademika Politeknik Negeri Malang.</li>
                                    <li>Pengguna wajib menjaga kerahasiaan kredensial.</li>
                            ...
                            <button class="btn btn-info btn-sm btn-block mt-3 rounded-pill" data-toggle="collapse" data-target="#termsCollapse">Kembali ke Registrasi</button>
                        </div>
                    </div>
                    ...
                    <div class="card-body bg-white" id="registerForm">
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="input-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                ...
                                <input name="nama" type="text" class="form-control border-left-0" placeholder="Nama Lengkap" value="{{ old('nama') }}" required autofocus>
                                @if ($errors->has('nama'))
                            ...
                            <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                ...
                                <input name="email" type="email" class="form-control border-left-0" placeholder="Email" required value="{{ old('email') }}">
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="input-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                ...
                                <input name="password" type="password" class="form-control border-left-0" placeholder="Password" required>
                            ...
                            <div class="input-group">
                                ...
                                <input name="password_confirmation" type="password" class="form-control border-left-0" placeholder="Konfirmasi Password" required>
                            ...
                            <div class="form-check text-left mt-3 pl-0">
                                <label class="form-check-label text-dark">
                                    ...
                                    <a href="#" class="text-info" data-toggle="collapse" data-target="#termsCollapse">{{ __('syarat dan ketentuan') }}</a>.
                                </label>
                            ...
                            <div class="card-footer bg-white border-0 pt-0">
                                <button type="submit" class="btn btn-info btn-round btn-block">{{ __('Get Started') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
