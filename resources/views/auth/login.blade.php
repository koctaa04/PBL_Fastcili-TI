                    ...
                    <div class="card card-login">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="email" value="{{ old('email', Cookie::get('remember_email')) }}" required autofocus>
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}" type="password" value="{{ Cookie::get('remember_password') }}" required>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                        ...
                                        <input class="form-check-input" name="remember" type="checkbox" value="1" {{ old('remember') || Cookie::get('remember_email') ? 'checked' : '' }}>
