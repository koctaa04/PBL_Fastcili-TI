        ...
        <form action="{{ url('/fasilitas/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
            ...
            <div class="modal-header bg-gradient-primary text-white">
                <h5 class="modal-title font-weight-bold">
                    <i class="fas fa-file-import mr-2"></i>Import Data Fasilitas
                </h5>
                ...
                <div class="card border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-0">
                            ...
                            <div>
                                <a href="{{ asset('template_fasilitas.xlsx') }}" class="btn btn-info" download>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="file_fasilitas" id="file_fasilitas" required>
                                <label class="custom-file-label bg-light text-center" for="file_fasilitas" id="file-label">
