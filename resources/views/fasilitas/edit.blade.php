        ...
        <form method="POST" action="{{ url('/fasilitas/update/' . $fasilitas->id_fasilitas) }}" id="form_edit">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control" name="nama_gedung" value="{{ $fasilitas->ruangan->gedung->nama_gedung }}">
                </div>
                <div class="form-group">
                    <label>Nama Ruangan</label>
                    <input type="text" disabled class="form-control" name="nama_ruangan" value="{{ $fasilitas->ruangan->nama_ruangan }}">
                </div>
                <div class="form-group">
