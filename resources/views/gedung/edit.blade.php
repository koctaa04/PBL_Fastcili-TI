        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('gedung.update', ['id' => $gedung->id_gedung]) }}" id="form_edit" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kode_gedung" id="kode_gedung" value="{{ $gedung->kode_gedung }}" required>
                    <small class="text-danger" id="error-kode_gedung"></small>
                </div>
                <div class="form-group mt-3">
                    <label for="nama_gedung">Nama Gedung</label>
                    <input type="text" class="form-control" name="nama_gedung" id="nama_gedung" value="{{ $gedung->nama_gedung }}" required>
                ...
                <div class="form-group mt-3">
                    <label for="foto_gedung" class="d-block mb-2">Foto Gedung (Kosongkan jika tidak ingin mengubah)</label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="foto_gedung" id="foto_gedung" accept="image/*">
                    ...
                    @if($gedung->foto_gedung)
                        <div class="mt-2">
                            ...
                            <img src="{{ asset('storage/uploads/foto_gedung/' . $gedung->foto_gedung) }}" class="img-thumbnail mt-1" style="max-height: 100px;">
                        </div>
                    @endif
...
$(document).ready(function() {
    ...
    $('#foto_gedung').on('change', function() {
        ...
        if (fileName) {
            ...
            $('#file-label').html('<i class="fas fa-upload mr-2"></i>Pilih File Baru (Kosongkan jika tidak ingin mengubah)');
        }
    });
