...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        User::insert([
            ...
            ['nama' => 'Dosen 1', 'akses' => '1', 'password' => Hash::make('password'),  'email' => 'dosen@jti.com',  'id_level' => 5],
            ['nama' => 'Tendik 1', 'akses' => '1', 'password' => Hash::make('password'),  'email' => 'tendik1@jti.com',  'id_level' => 6],
